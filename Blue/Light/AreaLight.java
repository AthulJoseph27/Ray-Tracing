...
// public AreaLight(int width, int height, Point center, double rx, double ry,
// double rz, Color color) {
// super(width, height, center, rx, ry, rz, color, -1);

// }

// @Override
// public double getDiffuseBrightness(Point p, Vector normal, Vector
// reflected_ray,
